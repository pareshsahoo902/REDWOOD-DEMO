...
import { QUERY } from 'src/components/Posts/PostsesCell'
    ...
    <div className="rw-segment rw-table-wrapper-responsive">
      <table className="rw-table">
        ...
        <tbody>
          {postses.map((posts) => (
            <tr key={posts.id}>
              <td>{truncate(posts.id)}</td>
              <td>{truncate(posts.title)}</td>
              <td>{truncate(posts.body)}</td>
              <td>{timeTag(posts.createdAt)}</td>
              <td>{timeTag(posts.updatedAt)}</td>
              <td>
                <nav className="rw-table-actions">
                  <Link
                    to={routes.posts({ id: posts.id })}
                    title={'Show posts ' + posts.id + ' detail'}
